...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    ...
    <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
            ...
            <a class="mdl-navigation__link" href="${pageContext.request.contextPath}/user/information"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">inbox</i>个人信息</a>
            ...
            <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
                <div class="tab-content">
                    <table class="table" cellpadding="6" cellspacing="1">
                        ...
                        <tr>
                            <th style="border: 0px solid transparent" class="tl">昵称</th>
                            <td style="border: 0px solid transparent" class="tr" id="nickNameVal">${user.nickname}</td>
                        </tr>
                        <tr>
                            <th style="border: 0px solid transparent" class="tl">性别</th>
                            <td style="border: 0px solid transparent" class="tr" id="sexVal">${user.sex}</td>
                        </tr>
                        <tr>
                            <th style="border: 0px solid transparent" class="tl">生日</th>
                            <td style="border: 0px solid transparent" class="tr" id="birthdayVal">
                                ${user.birthday.year+1900}年
                                ${user.birthday.month+1}月
                                ${user.birthday.date}日
                            </td>
                        </tr>
                        <%--
                        <tr>
