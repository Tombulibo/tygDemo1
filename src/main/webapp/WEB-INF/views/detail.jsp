...
<head>
    ...
    <title>通逸购-${goodsInfo['goods'].name}</title>
    ...
    <div class="container">
        ...
        <div class="shop_menu shop_menu_2 main-detail-div">
            <ul class="cramb_area cramb_area_5 main-detail-nav">
                ...
                <li class="br-active">${goodsInfo['goods'].name}</li>
            </ul>
        </div>
        <div class="row">
...
<%-----
                    ...
                    <div class="rel-div">
                        ...
                        <%--
                        <div class="add_defi new_meta">
                            <a data-original-title="Add to Wishlist" data-toggle="tooltip" class="fav-button big-font" data-id="${goodsInfo['goods'].id}">
